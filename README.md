...
Assistente operativo offline-first per commissioni, fiere, prodotti, clienti e vendite.
...
- [Historical data migration](docs/business/HISTORICAL-DATA-MIGRATION.md)
- [Data quality validation](docs/business/DATA-QUALITY-VALIDATION.md)
